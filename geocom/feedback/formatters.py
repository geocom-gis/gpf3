...
class FileLogFormatter(_logging.Formatter):
    """
    Custom log file formatter used by the :class:`geocom.feedback.handlers.FileLogHandler`.
...
class StreamFormatter(_logging.Formatter):
    """
    Custom log stream formatter used by the :class:`geocom.feedback.handlers.ArcLogHandler`.
