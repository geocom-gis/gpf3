...
import geocom.common.guids as _guids
...
class Where(object):
    ...
    When used in combination with the :py:mod:`geocom.tools.cursors` module, the Where clause can be passed-in directly.
    ...
    :type where_field:  str, geocom.tools.queries.Where
    :type operator:     str
    """
    ...
    def _format_value(value) -> str:
        ...
        If value is a :class:`geocom.common.guids.Guid` string, the result will be wrapped in curly braces and quoted.
