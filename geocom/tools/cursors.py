...
but there are some differences:
    ...
    - The cursors *where_clause* argument also accepts a :class:`geocom.tools.queries.Where` instance.
...
import geocom.tools.queries as _q
import geocom.tools.workspace as _ws
