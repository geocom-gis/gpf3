...
import geocom.tools.metadata as _metadata
import geocom.tools.queries as _queries
...
class ValueLookup(_BaseLookup):
    ...
    :param key_field:           The field to use for the ValueLookup dictionary keys.
                                ...
                                :func:`geocom.tools.lookup.coord_key` function.
    ...
    .. seealso::                When multiple fields should be stored in the lookup,
                                the :class:`geocom.tools.lookup.RowLookup` class should be used instead.
    """
...
class RowLookup(_BaseLookup):
    ...
    .. seealso::                When a single field value should be stored in the lookup,
                                the :class:`geocom.tools.lookup.ValueLookup` class should be used instead.
    """
